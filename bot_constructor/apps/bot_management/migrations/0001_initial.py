    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "api_key",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="Ключ API"
                    ),
                ),
                (
                    "api_url",
                    models.URLField(
                        blank=True, max_length=255, null=True, verbose_name="Адрес API"
                    ),
                ),
                (
                    "api_availability",
                    models.BooleanField(
                        default=False, null=True, verbose_name="Доступность API"
                    ),
                ),
                (
                    "bot_state",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(blank=True, null=True, verbose_name="Вкл/выкл"),
                ),
                (
                    "next_action",
                    models.ForeignKey(
